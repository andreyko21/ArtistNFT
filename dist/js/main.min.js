...
var Dropdown = /*#__PURE__*/function () {
  function Dropdown() {
    ...
    this.dropdown = jquery__WEBPACK_IMPORTED_MODULE_0__('.dropdown');
  ...
  _createClass(Dropdown, [{
    ...
    value: function BindEvents() {
      ...
      this.dropdownContent.on('click', '.dropdown__item', function (event) {
    ...
    value: function CheckScreenSize() {
      ...
      if (windowWidth <= 400) {
        jquery__WEBPACK_IMPORTED_MODULE_0__('.menu__footer').append(this.dropdown);
        var downHeight = jquery__WEBPACK_IMPORTED_MODULE_0__(window).height() - this.dropdown.offset().top - this.dropdown.height();
    ...
    key: "ChangArrow",
    value: function ChangArrow() {
      this.dropdownArrow;
    }
  }, {
    key: "SelectItem",
    value: function () {
      var _SelectItem = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
        var selectedItem, lastSelectItem;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              selectedItem = jquery__WEBPACK_IMPORTED_MODULE_0__(event.target);
              this.dropdownContent.find(selectedItem).remove();
              lastSelectItem = this.dropdownTrigger.find('.dropdown__item');
...
var Header = /*#__PURE__*/function () {
  function Header() {
    ...
    this.burgerMenu = jquery__WEBPACK_IMPORTED_MODULE_0__('.menu');
    this.BindEvents();
    this.dropDown = new _dropdown__WEBPACK_IMPORTED_MODULE_1__["default"]();
  }
  _createClass(Header, [{
    key: "BindEvents",
    value: function BindEvents() {
...
var MainPage = /*#__PURE__*/_createClass(function MainPage() {
  _classCallCheck(this, MainPage);
  this.header = new _modules_header__WEBPACK_IMPORTED_MODULE_0__["default"]();
});
